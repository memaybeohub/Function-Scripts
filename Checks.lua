...
function refreshTask() 
    ...
    if getgenv().CurrentTask == '' then  
        ...
        elseif (Sea2 or Sea3) and getgenv().ServerData['PlayerData'].Level >= 2550 and not table.find({'Skypiea',"Fishman","Ghoul"},getgenv().ServerData['PlayerData'].Race) and getgenv().ServerData['PlayerData'].Beli >= 2000000 and (getgenv().ServerData['PlayerData'].RaceVer ~= 'V3' and getgenv().ServerData['PlayerData'].RaceVer ~="V4") then 
